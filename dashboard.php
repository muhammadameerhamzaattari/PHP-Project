...
<body>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			<h1><marquee behavior=alternate direction="right" width="850"  scrollamount="2"><span style="color: blue">Welcome to Smart Booking System for Hotel Business</span></marquee></h1>
