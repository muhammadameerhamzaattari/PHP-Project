...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <div class="profile-sidebar">
        <div class="profile-userpic">
            <img src="assets/img/user.jpeg" class="img-responsive" alt="">
        </div>
        <div class="profile-usertitle">
            <div class="profile-usertitle-name"><?php echo $user['name'];?></div>
            <div class="profile-usertitle-status"><span class="indicator label-success"></span>HR Manager</div>
        </div>
        <div class="clear"></div>
    </div>
	...
	<?php }
        if (isset($_GET['addRoom'])){ ?>
            <li class="active">
                <a data-toggle="modal" data-target="#addRoom"><em class="fa fa-home">&nbsp;</em>
                    Add Room
                </a>
            </li>
        <?php } else{?>
	...
	<!----room  add closed--->
		...
		if (isset($_GET['add_emp'])){ ?>
            <li class="active">
                <a href="index.php?add_emp"><em class="fa fa-users">&nbsp;</em>
                   Add Employers
                </a>
            </li>
        <?php } else{?>
