<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"> <h1>Manage Rooms</h1></li>
        </ol>
    </div><!--/.row-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button title="Edit Room Information" style="border-radius:60px;" data-toggle="modal"
                                                ...
                                                id="roomEdit" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></button>
                                        <?php
                                        if ($rooms['status'] == 1) {
                                            echo '<button title="Customer Information" data-toggle="modal" data-target="#cutomerDetailsModal" data-id="' . $rooms['room_id'] . '" id="cutomerDetails" class="btn btn-sm btn-warning" style="border-radius:60px;"><i class="fa fa-eye"></i></button>';
                                        }
                                        ?>

                                        <a href="ajax.php?delete_room=<?php echo $rooms['room_id']; ?>"
                                           class="btn btn-sm btn-danger" style="border-radius:60px;" onclick="return confirm('Are you Sure?')"><i
                        ...
                        <div class="col-lg-12">
                            <form id="addRoom" data-toggle="validator" role="form">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                <button class="btn btn-primary pull-right">Add Room</button></div>
                            </form>
                        </div>
                    </div>
                </div>
