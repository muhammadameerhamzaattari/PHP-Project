<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><h1>Manage Staffs</h1></li>
        </ol>
    </div><!--/.row-->
                        ...
                        if (mysqli_num_rows($staff_result) > 0) {
                            while ($staff = mysqli_fetch_assoc($staff_result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="badge btn-warning" style="border-radius:0%" data-toggle="modal" data-target="#changeShift"
                                    ...
                                    <td>
                                        ...
                                        <button data-toggle="modal"
                                                ...
                                                class="btn btn-sm btn-info" style="border-radius:60px;"><i class="fa fa-pencil"></i></button>
                                        <a href='functionmis.php?empid=<?php echo $staff['emp_id']; ?>'
                                           class="btn btn-sm btn-danger" onclick="return confirm('Are you Sure?')" style="border-radius:60px;"><i
                                                    class="fa fa-trash"></i></a>
                                        <a href='index.php?emp_history&empid=<?php echo $staff['emp_id']; ?>'
                                           class="btn btn-sm btn-warning" title="Employee Histery" style="border-radius:60px;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
